			...
			{mangaka.mangakaName && (
				<main className="grid grid-cols-10 gap-4 bg-pink-700">
					<div className="col-start-2 col-span-8 flex flex-col">
						...
						<Link
							target="_BLANK"
							className="bg-blue-500 shadow-md hover:bg-blue-600 transition-all ease-in duration-200 text-white p-2 rounded px-14 w-64 mb-4 flex flex-row justify-center items-center gap-4 shadow-md"
